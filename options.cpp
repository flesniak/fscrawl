...
options::options()
  ...
  p_opts_optional.add_options()
    ...
    ("fakepath,f", value<string>(), "Instead of having basedir as absolute root directory, parse all files as if they were unter this fakepath")
    ...
    ("password,p", value<string>(), "Specify database user password")
